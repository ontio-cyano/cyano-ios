 ...
 */
+ (UIImage *)generateWithLogoQRCodeData:(NSString *)data logoImageName:(NSString *)logoImageName logoScaleToSuperView:(CGFloat)logoScaleToSuperView withWallet:(BOOL)isWallet {
    // 1、创建滤镜对象
    CIFilter *filter = [CIFilter filterWithName:@"CIQRCodeGenerator"];
    ...
    [color_filter setValue:isWallet?[CIColor colorWithRed:43.0 / 255.0 green:149.0 / 255.0 blue:209.0 / 255.0 ]:[CIColor colorWithRed:43.0 / 255.0 green:64.0 / 255.0 blue:69.0 / 255.0 ] forKey:@"inputColor0"];
    // 设定背景色
    [color_filter setValue:[CIColor colorWithRed:255.0 / 255.0 green:255.0 / 255.0 blue:255.0 / 255.0] forKey:@"inputColor1"];
