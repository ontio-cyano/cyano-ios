...
/** 扫描内容的 W 值 */
#define scanBorderW 260*SCALE_W
/** 扫描内容的 x 值 */
#define scanBorderX 57*SCALE_W
/** 扫描内容的 Y 值 */
#define scanBorderY (132*SCALE_W + SafeAreaTopHeight)
...
- (UIView *)contentView {
    if (!_contentView) {
        ...
        _contentView.frame = CGRectMake((SYSWidth - scanBorderW)/2, scanBorderY, scanBorderW, scanBorderW);
...
- (void)drawRect:(CGRect)rect {
    ...
    /// 空白区域设置
    [[[UIColor colorWithHexString:@"#5EA2FF"] colorWithAlphaComponent:0.5] setFill];
    ...
    [[UIImage imageNamed:@"cotscan"] drawInRect:CGRectMake((SYSWidth - scanBorderW)/2, scanBorderY, scanBorderW, scanBorderW)];
