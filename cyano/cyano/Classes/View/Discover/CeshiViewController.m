...
#import "InfoAlert.h"
@interface CeshiViewController ()<WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler> {
    WKWebView      *webView;
...
- (void)configUI {
    ...
    [webView.configuration.userContentController addScriptMessageHandler:self name:@"postmessage"];
...
// 加载网页
- (void)loadWeb {
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://192.168.3.67:8080/"]]];
